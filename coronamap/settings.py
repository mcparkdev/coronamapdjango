...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "f_czj1_7415fk!uru8h8io#e4lbt%lbrkwj)3+@^v=w%%dpt+5"
)
...
#             'HOST': '/cloudsql/coronamap-279822:southamerica-east1:coronamap-mysql',
#             'USER': 'mcparkdev',
#             'PASSWORD': '%:RqNN!$Dt2{d6DH',
#             'NAME': 'main',
#         }
#     }
# else:
